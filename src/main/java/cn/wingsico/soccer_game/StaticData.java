...
public class StaticData {
  ...
  public static String[] MALE_FIRST_NAME = {
  ...
  public static String[] FEMALE_FIRST_NAME = {
  ...
  public static final int LAST_NAME_LENGTH = LAST_NAME.length;
  public static final int FEMALE_FIRST_NAME_LENGTH = FEMALE_FIRST_NAME.length;
  public static final int MALE_FIRST_NAME_LENGTH = MALE_FIRST_NAME.length;
}
